...
class S {
  static const Map<String, String> _en = {
    ...
    'not_fish_title': 'Not a Fish',
    'not_fish_message': "This doesn't look like a fish. Please take a clear, close-up photo of just the fish.",
  ...
  static const Map<String, String> _bn = {
    ...
    'not_fish_title': 'এটি মাছ নয়',
    'not_fish_message': 'এটি মাছ বলে মনে হচ্ছে না। অনুগ্রহ করে শুধুমাত্র মাছের একটি স্পষ্ট ছবি তুলুন।',
